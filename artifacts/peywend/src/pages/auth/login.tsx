  ...
  return (
    <AuthLayout>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link href="/وشەی-نهێنی-فەرامۆشکردم"
                className="text-xs text-muted-foreground hover:text-primary transition-colors">
                وشەی نهێنیت فەرامۆش کردووە؟
              </Link>
            </div>

            <Button type="submit" className="w-full h-12 rounded-xl text-md gap-2" disabled={loginMutation.isPending}>
      ...
      <div className="text-center mt-6 text-sm text-muted-foreground">
        ژمارەت نییە؟{" "}
        <Link href="/تومارکردن" className="text-primary hover:underline font-bold">دروستکردنی ژمارە</Link>
      </div>
    </AuthLayout>
  );
}
